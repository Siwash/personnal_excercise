 ...
 *      名称字典（kohgylw.randomChineseName.core.GivenameDictionaries）
 * @see SurnameDictionaries
 *      姓氏字典（kohgylw.randomChineseName.core.SurnameDictionaries）
 * @author kohgylw
 * @version 1.0
 */
public class RandomChineseNameUtile {
	 ...
	 */
	public RandomChineseNameUtile(SurnameDictionaries sd, GivenameDictionaries gd) {
		// 获取数据字典
		if (sd != null && gd != null) {
			this.sd = sd;
			this.gd = gd;
