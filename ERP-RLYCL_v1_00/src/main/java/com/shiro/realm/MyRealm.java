...
public class MyRealm extends AuthorizingRealm {  
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals){  
        System.err.println("getAuthorization");
...
//      }  
        ...
        if("papio".equals(token.getUsername())){
            ...
            AuthenticationInfo authcInfo=new SimpleAuthenticationInfo(principal, "62a1e1b0c4acbb8d195cad7a4df0445e", credentialsSalt, getName());
            this.setSession("currentUser", "papio");  
            return authcInfo;  
        }else if("big".equals(token.getUsername())){  
            AuthenticationInfo authcInfo = new SimpleAuthenticationInfo(principal, "a08e44f610f66503647068d5f856a440",credentialsSalt,this.getName());  
    ...
    public static void main(String[] args) {
    	...
    	Object salt=ByteSource.Util.bytes("papio");
