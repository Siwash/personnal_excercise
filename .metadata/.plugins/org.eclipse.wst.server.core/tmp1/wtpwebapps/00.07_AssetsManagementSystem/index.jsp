...
<body>
		...
		<div id="side-nav">
			<ul id="nav">
				...
				<li><a href="javascript:;"> <img src="images/member.png"
						class="left-menu-icon"> <cite>职工管理</cite> <i
				...
				<!-- 这是另一组菜单示例 -->
				<li><a href="javascript:;"> <img src="images/property.png"
						class="left-menu-icon"> <cite>我的资产</cite> <i
						class="iconfont nav_right">&#xe697;</i>
				</a>
					<ul class="sub-menu">
						<li><a _href="applyController/showApplyByUserName.do"> <i
								class="iconfont">&#xe6a7;</i> <cite>在用资产</cite>
						</a></li>
						<li><a _href="applyController/addApply.do"> <i
								class="iconfont">&#xe6a7;</i> <cite>资产申请</cite>
						</a></li>
						<li><a _href="porchaseController/showPorchaseByUserName.do">
								<i class="iconfont">&#xe6a7;</i> <cite>采购申请</cite>
						</a></li>
					</ul></li>
				<!-- 示例结束 -->
				...
				<li><a href="javascript:;"> <img
						src="images/processmmt.png" class="left-menu-icon"> <cite>流程管理</cite>
						<i class="iconfont nav_right">&#xe697;</i>
				</a>
					<ul class="sub-menu">
						<li><a _href="porchaseController/showPorchase.do"> <i
								class="iconfont">&#xe6a7;</i> <cite>采购批准</cite>
						</a></li>
						<li><a _href="applyController/showAllapply.do"> <i
								class="iconfont">&#xe6a7;</i> <cite>申请批准</cite>
						</a></li>
						<li><a _href="maintainController/showallmaintain.do"> <i
								class="iconfont">&#xe6a7;</i> <cite>报修批准</cite>
						</a></li>
					</ul></li>
				<!-- 示例结束 -->

				<!-- 这是另一组菜单示例 -->
				<li><a href="javascript:;"> <img src="images/gold.png"
						class="left-menu-icon"> <cite>资金核算</cite> <i
						class="iconfont nav_right">&#xe697;</i>
				</a>
					<ul class="sub-menu">
						<li><a _href="view/porchase/quary_bill.jsp"> <i
								class="iconfont">&#xe6a7;</i> <cite>采购核算</cite>
						</a></li>
					</ul></li>
				<!-- 示例结束 -->
				...
				<!-- 这是另一组菜单示例 -->
				<li><a href="javascript:;"> <img src="images/warehouse.png"
						class="left-menu-icon"> <cite>库存管理</cite> <i
						class="iconfont nav_right">&#xe697;</i>
				</a>
					<ul class="sub-menu">
						<li><a _href="propertyController/showAllProperty.do"> <i
								class="iconfont">&#xe6a7;</i> <cite>库存资产</cite>
						</a></li>
						<li><a _href="propertyController/showBorrowreturn.do"> <i
								class="iconfont">&#xe6a7;</i> <cite>资产流动记录</cite>
						</a></li>
					</ul></li>
				<!-- 示例结束 -->
	...
	<!-- 底部开始 -->
	<div class="footer">
		<div class="copyright">舒松©2017 前端：x-admin v2.3 后端：舒松-java EE项目</div>
	</div>
	<!-- 底部结束 -->
</body>
</html>