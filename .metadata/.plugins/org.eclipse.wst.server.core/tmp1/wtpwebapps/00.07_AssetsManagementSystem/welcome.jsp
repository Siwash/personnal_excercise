	...
	<div class="x-body">
		...
		<blockquote class="layui-elem-quote layui-quote-nm">
			...
			前端框架整合：舒松（ss112476@163.com）； 项目开发：企业资产管理系统（<a
				onclick="parent.x_admin_show('企业资产管理系统主页','http://localhost:8080/00.07_AssetsManagementSystem/indexController/entryIndex.do')">http://localhost:8080/00.07_AssetsManagementSystem/indexController/entryIndex.do</a>）java
			EE项目组
		</blockquote>
	</div>
</body>
