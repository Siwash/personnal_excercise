 ...
 * Generated at: 2018-04-29 06:22:17 UTC
...
public final class property_005fadd_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
	...
	String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort()
      ...
      out.write("\tsrc=\"");
      out.print(basePath);
      out.write("view/property/combineMenu.js\"></script>\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("\t$(document).ready(function() {\r\n");
      out.write("\t\t$(\"#flip\").click(function() {\r\n");
      out.write("\t\t\t$(\"#panel\").toggle();\r\n");
      out.write("\t\t\t$(\"#panel2\").toggle();\r\n");
      out.write("\t\t\tvar btn = \"新建添加\"\r\n");
      out.write("\t\t\tif ($(\"#flip\").text() == \"新增分类\") {\r\n");
      out.write("\t\t\t\t$(\"#flip\").text(\"已有分类选择\");\r\n");
      out.write("\t\t\t} else {\r\n");
      out.write("\t\t\t\t$(\"#flip\").text(\"新增分类\");\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t});\r\n");
      out.write("\r\n");
      out.write("\t\t$(\"#flip2\").click(function() {\r\n");
      out.write("\t\t\t$(\"#panel3\").toggle();\r\n");
      out.write("\t\t\t$(\"#panel4\").toggle();\r\n");
      out.write("\t\t\tvar btn = \"新建添加\"\r\n");
      out.write("\t\t\tif ($(\"#flip2\").text() == \"新增分类\") {\r\n");
      out.write("\t\t\t\t$(\"#flip2\").text(\"已有分类选择\");\r\n");
      out.write("\t\t\t} else {\r\n");
      out.write("\t\t\t\t$(\"#flip2\").text(\"新增分类\");\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t\t$(\"#panel5\").toggle();\r\n");
      out.write("\t\t\t$(\"#panel6\").toggle();\r\n");
      out.write("\t\t\tvar btn = \"新建添加\"\r\n");
      out.write("\t\t\tif ($(\"#flip3\").text() == \"新增分类\") {\r\n");
      out.write("\t\t\t\t$(\"#flip3\").text(\"已有分类选择\");\r\n");
      out.write("\t\t\t} else {\r\n");
      out.write("\t\t\t\t$(\"#flip3\").text(\"新增分类\");\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\t});\r\n");
      out.write("\t});\r\n");
      ...
      out.write("\t\t\taction=\"propertyController/addProperty.do\">\r\n");
      ...
      out.write("\t\t\t\t\t\t<option value=\"\" selected=\"selected\">----从已有分类选择----</option>\r\n");
      out.write("\t\t\t\t\t\t<option value=\"固定资产\">固定资产</option>\r\n");
      out.write("\t\t\t\t\t\t<option value=\"非实物资产\">非实物资产</option>\r\n");
      out.write("\t\t\t\t\t\t<option value=\"低值易耗损品\">低值易耗损品</option>\r\n");
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"layui-form-item\" id=\"panel2\">\r\n");
      out.write("\t\t\t\t<label for=\"L_repass\" class=\"layui-form-label\"><span\r\n");
      out.write("\t\t\t\t\tclass=\"x-red\">*</span>分类 </label>\r\n");
      out.write("\t\t\t\t<div class=\"layui-input-inline\">\r\n");
      out.write("\t\t\t\t\t<input name=\"malltypeName2\" type=\"text\" id=\"L_repass\"\r\n");
      out.write("\t\t\t\t\t\tautocomplete=\"off\" class=\"layui-input\" placeholder=\"输入新的分类\">\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t<label for=\"L_repass\" class=\"layui-form-label\"> </label>\r\n");
      out.write("\t\t\t\t<div class=\"layui-input-inline\">\r\n");
      out.write("\t\t\t\t\t<a class=\"layui-btn-warm\" id=\"flip\">新增分类</a>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<option value=\"\" selected=\"selected\">----从已有资产选择----</option>\r\n");
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t<div class=\"layui-form-item\" id=\"panel4\">\r\n");
      out.write("\t\t\t\t<label for=\"L_repass\" class=\"layui-form-label\"><span\r\n");
      out.write("\t\t\t\t\tclass=\"x-red\">*</span>资产 </label>\r\n");
      out.write("\t\t\t\t<div class=\"layui-input-inline\">\r\n");
      out.write("\t\t\t\t\t<input name=\"propertyName2\" type=\"text\" id=\"L_repass\"\r\n");
      out.write("\t\t\t\t\t\tautocomplete=\"off\" class=\"layui-input\" placeholder=\"输入新的资产\">\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t<label for=\"L_repass\" class=\"layui-form-label\"> </label>\r\n");
      out.write("\t\t\t\t<div class=\"layui-input-inline\">\r\n");
      out.write("\t\t\t\t\t<a class=\"layui-btn-warm\" id=\"flip2\">新增资产</a>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<option value=\"\">----从已有型号选择----</option>\r\n");
      ...
      out.write("\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t<div class=\"layui-form-item\" id=\"panel6\">\r\n");
      out.write("\t\t\t\t<label for=\"L_repass\" class=\"layui-form-label\"><span\r\n");
      out.write("\t\t\t\t\tclass=\"x-red\">*</span>类型 </label>\r\n");
      out.write("\t\t\t\t<div class=\"layui-input-inline\">\r\n");
      out.write("\t\t\t\t\t<input name=\"type2\" type=\"text\" id=\"L_repass\"\r\n");
      out.write("\t\t\t\t\t\tautocomplete=\"off\" class=\"layui-input\" placeholder=\"输入新的类型\">\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t<label for=\"L_repass\" class=\"layui-form-label\"> </label>\r\n");
      out.write("\t\t\t\t<div class=\"layui-input-inline\">\r\n");
      out.write("\t\t\t\t\t<a class=\"layui-btn-warm\" id=\"flip3\">新增类型</a>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t<label for=\"L_repass\" class=\"layui-form-label\"> </label>\r\n");
      out.write("\t\t\t\t<button class=\"layui-btn\" type=\"submit\">提交</button>\r\n");
      out.write("\t\t\t\t<button class=\"layui-btn\" type=\"button\" onclick=\"returnUserApply()\">重置</button>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</form>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<script>\r\n");
