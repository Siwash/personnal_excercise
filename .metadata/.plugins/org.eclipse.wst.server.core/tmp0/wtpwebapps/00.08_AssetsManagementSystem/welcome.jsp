...
<body>
	<div class="x-body">
		...
		<blockquote class="layui-elem-quote layui-quote-nm">
			...
			前端框架整合：冉鹏峰（496690402@qq.com）； 项目开发：企业资产管理系统（<a
				onclick="parent.x_admin_show('企业资产管理系统主页','http://localhost:8080/00.08_AssetsManagementSystem/indexController/entryIndex.do')">http://localhost:8080/00.08_AssetsManagementSystem/indexController/entryIndex.do</a>）毕业设计
		</blockquote>
	</div>
</body>
<script type="text/javascript">
