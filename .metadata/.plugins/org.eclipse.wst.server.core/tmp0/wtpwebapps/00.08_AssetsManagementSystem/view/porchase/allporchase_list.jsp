...
<body onload="load()">
	...
	<div class="x-body">
		<div class="layui-row">
			<form class="layui-form layui-col-md12 x-so" method="post" action="porchaseController/showPorchase.do">
				...
				<input class="layui-input" placeholder="请输入名称"
					name="propertyName">
				</div>
				<div class="layui-input-inline">	
				...
				<div class="layui-input-inline">
				<button type="submit" class="layui-btn layui-input-inline" lay-submit="sreach()" lay-filter="sreach">
	...
	<!-- 	<div class="layui-row">
		...
		<blockquote class="layui-elem-quote">共有数据：${porchasesNum } 条</blockquote>
