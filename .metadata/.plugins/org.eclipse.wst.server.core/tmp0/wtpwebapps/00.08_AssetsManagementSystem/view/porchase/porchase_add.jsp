...
<body>
	<div class="x-body">
		<form class="layui-form" method="post" action="porchaseController/addPorchase.do" >
			<div class="layui-form-item">
				<label for="L_id" class="layui-form-label"> <span
					class="x-red">*</span>资产名称
				</label>
				<div class="layui-input-inline">
					<input name="propertyName" type="text" id="L_id" autocomplete="off"
						class="layui-input">
				</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input name="type" type="text" id="L_repass"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input name="propertyPrece" type="text" id="L_repass"
						autocomplete="off" class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
