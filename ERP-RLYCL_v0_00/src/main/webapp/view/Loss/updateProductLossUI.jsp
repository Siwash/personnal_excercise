...
<script type="text/javascript">
 ...
 <body>
   <div class="x-body">
        <form class="layui-form"  action="<%=basePath%>StorehouseController/updateProductLoss.do" method="post">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="model" name="model" value="${product.model}" readonly="true"
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="name" name="name" value="${product.name}" readonly="true"
                  autocomplete="off" class="layui-input">
              </div>
              <div class="layui-form-mid layui-word-aux">
                  <span class="x-red">*</span>此栏不能改动
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-form-mid layui-word-aux">
                  <span class="x-red">*</span>请修改产品损耗状态
              </div>
          </div>
