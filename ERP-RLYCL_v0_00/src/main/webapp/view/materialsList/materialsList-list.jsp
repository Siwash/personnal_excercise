...
<body>
	<div class="x-nav">
		<span class="layui-breadcrumb"> <a>部门管理</a> <a> <cite>材料管理</cite></a>
	...
	<div class="x-body">
		<div class="layui-row">
			<form class="layui-form layui-col-md12 x-so">
				<span>快速查询：</span>
				<input class="layui-input" placeholder="请输入材料型号" name="materialName">
				<input type="text" name="materialType" placeholder="请输入材料类型"
