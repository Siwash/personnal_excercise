...
<body>
	...
	<script>
		...
		function search(){
			...
			$.ajax({
				...
				success:function(result){
					...
					var demo="";
					for(var x in mlist){
						var herfs="purchaseController/productPurchaseMaterialsList.do?materialId="+mlist[x].materialId;
						demo+="<tr>";
						...
						demo+="<td><a onclick='x_admin_show(\"添加订单\",\""+herfs+"\")'>采购</a></td>";
						demo+="</tr>";
					}
					$("#normal").html(demo);
		...
		$(function(){
			if(i==null|i==""){
				window.location.href="<%=basePath%>purchaseController/initKKpager.do"
			};
		...
		function showPage(n){
			$.ajax({
				...
				url:"purchaseController/showPage.ajax",
				dataType:"text",
				success:function(result){
					console.log(result);
				...
				$.each(myPage,function(n,val){
					var herfs="purchaseController/productPurchaseMaterialsList.do?materialId="+val.materialId;
					console.log(herfs);
					var demo="";
					demo+="<tr>";
					demo+="<td>"+val.materialId+"</td>"
					demo+="<td>"+val.materialName+"</td>";
					demo+="<td>"+val.materialType+"</td>";
					demo+="<td>"+val.materialPrice+"</td>";
					demo+="<td>"+val.materialDescribe+"</td>";
					demo+="<td><a onclick='x_admin_show(\"添加订单\",\""+herfs+"\")'>采购</a></td>"
					demo+="</tr>";
					$("#normal").append(demo);
