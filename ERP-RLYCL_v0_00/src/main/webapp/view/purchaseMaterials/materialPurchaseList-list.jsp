...
<body>
	...
	<script>
		...
		/*分页控件设置*/
		var i="${sessionScope.TDATAS}";
		var j="${sessionScope.TPAGES}";
		console.log(i);
		$(function(){
			if(i==null|i==""){
				window.location.href="<%=basePath%>purchaseController/initKKpager1.do"
			};
		...
		function showPage(n){
			$.ajax({
				...
				url:"purchaseController/showPage1.ajax",
				dataType:"text",
				...
				$.each(myPage,function(n,val){
					...
					var demo="";
					demo+="<tr>";
					demo+="<td>"+val.trackingNumber+"</td>"
					demo+="<td>"+val.materialId+"</td>";
					demo+="<td>"+val.materialName+"</td>";
					demo+="<td>"+val.materialNum+"</td>";
					demo+="<td>"+val.purchasePrice+"</td>";
					demo+="<td>"+val.purchaseTimeString+"</td>";;
					demo+="<td>"+val.emeName+"</td>";
					demo+="<td>"+val.opinion+"</td>";
					demo+="</tr>";
					$("#normal").append(demo);
