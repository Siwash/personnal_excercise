...
<script type="text/javascript" src="<%=basePath%>view/materials/listPage3.js"></script>
<script type="text/javascript">
        function load() {
...
<body onload="load()">
	...
	<div class="x-body">
		...
		<span class="x-right" style="line-height: 40px">共有数据:${MaterialsRecordList.size()}条</span> </xblock>
         <table class="layui-table" id="normal">
			...
			<tbody>
				<c:forEach items="${pageResult.dataList}" var="MaterialsRecord">
					<tr>
						<td>${MaterialsRecord.materialId}</td>
						<td>${MaterialsRecord.materialNum}</td>
						<td><fmt:formatDate value="${MaterialsRecord.recordTime}"
							pattern="yyyy-MM-dd HH:mm:ss" /></td>
						
						<td>${MaterialsRecord.materialType}</td>
