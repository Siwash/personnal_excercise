...
<script type="text/javascript">
 ...
 <body>
   <div class="x-body">
        <form class="layui-form"  action="<%=basePath%>StorehouseController/updateProduct.do" method="post">
        	<input type="hidden" name="productId" value="${product.productId}">
        	<input type="hidden" name="pInventoryId" value="${productInventory.pInventoryId}">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="inventoryNumber" name="inventoryNumber" value="${productInventory.inventoryNumber}"
                  autocomplete="off" class="layui-input">
              </div>
              <div class="layui-form-mid layui-word-aux">
                  <span class="x-red">*</span>请输入产品数量
              </div>
          </div>
