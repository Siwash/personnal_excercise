...
<body>
	<div class="x-body">
		<blockquote class="layui-elem-quote">欢迎进入青阳ERP管理系统！v1.0；登录时间：YYYY-MM-DD；</blockquote>
		<fieldset class="layui-elem-field">
			...
			<div class="layui-field-box">
				<table class="layui-table">
					<thead>
						<tr>
							<th colspan="2" scope="col"> <a href="testController/test.do">test</a>您的账户信息</th>
						</tr>
					</thead>
					<tbody>
						<tr>
							<th width="30%">您的账号</th>
							<td><span>${userAccount}</span></td>
						</tr>
						<tr>
							<td>您的姓名</td>
							<td>${userName }</td>
				...
				<table class="layui-table">
					...
					<tbody>
						...
						<tr class="spanLinkTr">
							<td>当前在线人数</td>
							<td><span id="olnum">加载中...</span>&nbsp; <span id="ronBtn" onclick="reOnlineNum()" class="spanLink">点击刷新</span>
							</td>
						</tr>
						<tr>
							<td>登录超时时间</td>
							<td>${MaxLoginTime }秒</td>
						</tr>
						<tr class="spanLinkTr">
							<td>服务器当前时间</td>
...
<script type="text/javascript">
	...
	function getOnlineNum(){
		$.ajax({
			type:"POST",
			url:"indexController/getOnlineNum.ajax",
			data:{
